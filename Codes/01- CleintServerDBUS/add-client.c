...
request = dbus_message_new_method_call (SERVER_BUS_NAME, SERVER_OBJECT_PATH_NAME, 
        ...
        */
        dbus_connection_send_with_reply (conn, request, &pending_return, -1);
    ...
    /*Block until the pending call is completed*/
     ...
     /*Decrements the reference count on a pending call, freeing it if the count reaches 0.*/
        ...
        */
        ...
        dbus_bus_release_name (conn, CLIENT_BUS_NAME, &dbus_error);
